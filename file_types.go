...
var lang_spec = map[string]LanguageSpec{
	"actionscript": {Name: "actionscript", Exts: []string{"as", "mxml"}},
	"ada":          {Name: "ada", Exts: []string{"ada", "adb", "ads"}},
	"asciidoc":     {Name: "asciidoc", Exts: []string{"adoc", "ad", "asc", "asciidoc"}},
	"apl":          {Name: "apl", Exts: []string{"apl"}},
	"asm":          {Name: "asm", Exts: []string{"asm", "s"}},
	"asp":          {Name: "asp", Exts: []string{"asp", "asa", "aspx", "asax", "ashx", "ascx", "asmx"}},
	"aspx":         {Name: "aspx", Exts: []string{"asp", "asa", "aspx", "asax", "ashx", "ascx", "asmx"}},
	"batch":        {Name: "batch", Exts: []string{"bat", "cmd"}},
	"bazel":        {Name: "bazel", Exts: []string{"bazel"}},
	"bitbake":      {Name: "bitbake", Exts: []string{"bb", "bbappend", "bbclass", "inc"}},
	"cc":           {Name: "cc", Exts: []string{"c", "h", "xs"}},
	"cfmx":         {Name: "cfmx", Exts: []string{"cfc", "cfm", "cfml"}},
	"chpl":         {Name: "chpl", Exts: []string{"chpl"}},
	"clojure":      {Name: "clojure", Exts: []string{"clj", "cljs", "cljc", "cljx", "edn"}},
	"coffee":       {Name: "coffee", Exts: []string{"coffee", "cjsx"}},
	"config":       {Name: "config", Exts: []string{"config"}},
	"coq":          {Name: "coq", Exts: []string{"coq", "g", "v"}},
	"cpp":          {Name: "cpp", Exts: []string{"cpp", "cc", "C", "cxx", "m", "hpp", "hh", "h", "H", "hxx", "tpp"}},
	"crystal":      {Name: "crystal", Exts: []string{"cr", "ecr"}},
	"csharp":       {Name: "csharp", Exts: []string{"cs"}},
	"cshtml":       {Name: "cshtml", Exts: []string{"cshtml"}},
	"css":          {Name: "css", Exts: []string{"css"}},
	"cython":       {Name: "cython", Exts: []string{"pyx", "pxd", "pxi"}},
	"delphi":       {Name: "delphi", Exts: []string{"pas", "int", "dfm", "nfm", "dof", "dpk", "dpr", "dproj", "groupproj", "bdsgroup", "bdsproj"}},
	"dlang":        {Name: "dlang", Exts: []string{"d", "di"}},
	"dot":          {Name: "dot", Exts: []string{"dot", "gv"}},
	"dts":          {Name: "dts", Exts: []string{"dts", "dtsi"}},
	"ebuild":       {Name: "ebuild", Exts: []string{"ebuild", "eclass"}},
	"elisp":        {Name: "elisp", Exts: []string{"el"}},
	"elixir":       {Name: "elixir", Exts: []string{"ex", "eex", "exs"}},
	"elm":          {Name: "elm", Exts: []string{"elm"}},
	"erlang":       {Name: "erlang", Exts: []string{"erl", "hrl"}},
	"factor":       {Name: "factor", Exts: []string{"factor"}},
	"fortran":      {Name: "fortran", Exts: []string{"f", "F", "f77", "f90", "F90", "f95", "f03", "for", "ftn", "fpp", "FPP"}},
	"fsharp":       {Name: "fsharp", Exts: []string{"fs", "fsi", "fsx"}},
	"gettext":      {Name: "gettext", Exts: []string{"po", "pot", "mo"}},
	"glsl":         {Name: "glsl", Exts: []string{"vert", "tesc", "tese", "geom", "frag", "comp"}},
	"go":           {Name: "go", Exts: []string{"go"}},
	/* fixme
